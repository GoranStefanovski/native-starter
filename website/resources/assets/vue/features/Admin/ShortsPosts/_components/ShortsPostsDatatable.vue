<script setup lang="ts">
  ...
  import ShortsPostsTableRow from '../../../../views/admin/ShortsPosts/ShortsPostsTableRow.vue';
  
  const props = defineProps(['columns']);
  const endpoint: string = 'common/short-posts';
...
<template>
  <Datatable
    ...
    :loading="loading"
    :columns="columns"
    lang-key="posts_short"
    add-route-name="add.post_short"
