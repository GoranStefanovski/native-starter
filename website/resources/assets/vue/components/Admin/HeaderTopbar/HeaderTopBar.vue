<script setup lang="ts">
  ...
  import './UserDropDown.vue';
  import UserDropDown from "@/components/Admin/HeaderTopbar/UserDropDown.vue";

  const dropdownOpen = ref(false);
  const backgroundImage = './assets/media/misc/bg-1.jpg'; // Adjust the image URL
  const username = 'Sean Stone';
  const messagesBadge = '23 messages'; // Change to your data
