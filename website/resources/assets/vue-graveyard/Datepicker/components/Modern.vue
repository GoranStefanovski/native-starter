<script lang="ts">
  ...
  import {
    format , startOfMonth , getDay , addDays , isToday ,  isSameDay , isSameMonth , lastDayOfMonth , eachDayOfInterval , addMonths , setMonth , getMonth , isPast , subDays
  } from "date-fns/esm/index";
  ...
  <div class="sk-calendar-modern">
    ...
    <div class="sk-calendar-modern__days-container">
      ...
      >
        ...
        >
          <span
            v-for="(day, index) in modernDates"
            :key="index"
