<script lang="ts">
  ...
  import { format , startOfMonth , getDay , addDays , isToday , isSameDay , isSameMonth , lastDayOfMonth , eachDayOfInterval , addMonths , setMonth , getMonth , isPast , subDays } from "date-fns/esm/index";
  import ModernDatepicker from './components/Modern.vue';
  import DatepickerConst from "./constants/Datepicker";
...
<template>
  ...
  >
    <div class="sk-calendar-classic__header">
      ...
      <div class="sk-calendar-classic__day-labels">
        <span
          ...
          :key="dayLabel"
          class="sk-calendar-classic__day-label"
        >
          {{ dayLabel }}
        </span>
      </div>
    ...
    <div class="sk-calendar-classic__body">
      <span
        v-for="day in classicDates"
        :key="day"
        class="sk-calendar-classic__day"
      >

        <span
          class="sk-calendar-classic__day-value"
  ...
  <div
    v-else-if="type==='modern'"
    class="sk-calendar-modern"
  >
    ...
    <div class="sk-calendar-modern__days-container">
      ...
      <div
        ...
        class="sk-calendar-modern__days-inner"
        @mousedown="startDrag"
        @mousemove="doDrag"
      >
        <div
          class="sk-calendar-modern__days-wrap"
          :class="{
        ...
        >
          <div
            v-for="day in modernDates"
            :key="day"
            class="sk-calendar-modern__day"
          >
            <div
              class="sk-calendar-modern__day-inner"
